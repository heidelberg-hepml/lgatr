...
def test_equi_layer_norm_correctness(batch_dims: tuple[int, ...], scale: float) -> None:
    # equi_layer_norm rescales inputs to have unit mean squared GA norm regardless of input scale.
...
@pytest.mark.parametrize("batch_dims", [(7, 9)])
def test_equi_layer_norm_equivariance(batch_dims: tuple[int, ...]) -> None:
